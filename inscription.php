			    			...
			    			<div class="col-xs-offset-3 col-xs-6">
								...
								<div class="form-group"> 
									...
									<label for="code_id" class="control-label">Code Postal</label>
										<input type="text" class="form-control" id="code_id" name="postal" placeholder="Code Postal">
								</div>
								<div class="form-group">
									<!-- Ville-->
									<label for="city_name" class="control-label">Ville</label>
										<input type="text" class="form-control" id="city_name" name="city" placeholder="Ville" value=""  >
								</div>			
								<div class="form-group"> 
									<!-- GPS-->
